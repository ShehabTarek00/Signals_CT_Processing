...
Motion_Blured_Image_Freq_Domain = fft2(Motion_Blured_Image);

Restored_Image = ifft2(Motion_Blured_Image_Freq_Domain./Horz_blur_Kernel_Freq_Domain);
...
% Motion_Blured_Image = 30*uint16(Motion_Blured_Image);
